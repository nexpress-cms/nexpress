...
| `authoring-reliability.spec.ts` | Admin unsaved-navigation guard, failed-save dirty-state preservation, revision diff visibility, and latest-autosave recovery into an unsaved form state.                             |
