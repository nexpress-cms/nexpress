...
| `pipeline.integration.test.ts`               | saveDocument create/update, site-stamped save/delete follow-up jobs, monotonic revision pruning, findDocuments round-trip, and transactional document/revision deletion                                                              |
