...
| `preview.spec.ts`               | Admin Preview links for draft pages and posts, including public-route 404 before draft mode and draft-mode render at the collection's real public URL.                                                   |
