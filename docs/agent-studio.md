...
| Worker subscriptions                | Up to 100 retained heartbeats are sampled. Owner-recorded subscriptions distinguish subscribed, paused, inactive, stale, marked-stopped and unknown evidence. Registration or a generic heartbeat alone cannot prove an Agent consumer. Even a fresh subscription does not prove progress, provider readiness or coverage of every required queue.                                                         |
...
[worker subscriptions](design/agentic-platform/agent-worker-evidence.md).
