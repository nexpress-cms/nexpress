...
Source: `packages/core/AGENTS.md`, extracted 2026-09-14. Detailed guidance retained from the original AGENTS.md. Read the relevant section before changing that area; do not preload the whole document. Dated inventories and implementation status must be checked against current code and the current handoff.
