...
export function MagazineNotFound(): React.ReactElement {
  return (
    <div className="np-magazine-not-found np-magazine-message">
      ...
      <h1 className="np-magazine-message-title">This story isn&apos;t in the archive.</h1>
      <p className="np-magazine-message-body">
        The page you were looking for has been moved, retitled, or never made it to print. Try the
