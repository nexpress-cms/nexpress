...
async function digestCanonicalBytes(value: Uint8Array): Promise<`cj1:sha256:${string}`> {
...
export async function npDigestAgentEffectProfileCanonical(
  ...
  return digestCanonicalBytes(npBuildAgentEffectProfileCanonicalBytes(value).domainSeparatedUtf8);
}

export async function npDigestAgentRunLimitsCanonical(
  value: unknown,
): Promise<`cj1:sha256:${string}`> {
  return digestCanonicalBytes(npBuildAgentRunLimitsCanonicalBytes(value).domainSeparatedUtf8);
}
...
export async function npDigestAgentVaultAadCanonical(
  ...
  return digestCanonicalBytes(npBuildAgentVaultAadCanonicalBytes(value).domainSeparatedUtf8);
}
