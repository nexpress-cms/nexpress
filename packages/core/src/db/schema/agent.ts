...
export const npAgentApprovals = pgTable(
 ...
 ((${t.decisionBody}->>'decision'='reject' and ${t.decisionBody}->'reauthentication'->>'mode'='none' and ${t.decisionReauthFingerprint} is null and ${t.decisionReauthenticatedAt} is null) or (${t.decisionBody}->>'decision'='approve' and ((${t.requiredReauthMode}='none' and ${t.decisionBody}->'reauthentication'->>'mode'='none' and ${t.decisionReauthFingerprint} is null and ${t.decisionReauthenticatedAt} is null) or (${t.requiredReauthMode}='recent-staff-primary' and ${t.decisionBody}->'reauthentication'->>'mode'='recent' and ${t.decisionReauthFingerprint} is not null and ${t.decisionReauthenticatedAt} is not null)))))) and
