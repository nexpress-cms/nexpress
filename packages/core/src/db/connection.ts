 ...
 * or globally via `NX_DB_CONNECTION_TIMEOUT_MS` / `NX_DB_STATEMENT_TIMEOUT_MS`.
 *
 ...
 */
const DEFAULT_CONNECTION_TIMEOUT_MS = readEnvPositiveInt("NX_DB_CONNECTION_TIMEOUT_MS", 5_000);
const DEFAULT_STATEMENT_TIMEOUT_MS = readEnvPositiveInt("NX_DB_STATEMENT_TIMEOUT_MS", 10_000);
