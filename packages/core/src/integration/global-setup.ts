 ...
 * tests rationale. Lives next to the consumers so vitest can resolve
 * relative paths from `vitest.integration.config.ts` without leaning on
 * package exports (the file isn't part of the public surface).
 */
