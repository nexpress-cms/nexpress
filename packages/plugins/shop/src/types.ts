...
export interface NpShopMessages {
  ...
  orderExchangeDestination: string;
  orderExchangeDestinationAwaiting: string;
  orderExchangeDestinationSubmitted: string;
  orderExchangeDestinationAccessed: string;
  orderExchangeDestinationExpired: string;
  orderExchangeDestinationSubmit: string;
  orderExchangeDestinationSubmitting: string;
  orderExchangeDestinationPrivacy: string;
  orderExchangeDestinationFailed: string;
  ...
  orderReturnPostageQuote: string;
  orderReturnPostageQuoting: string;
  orderReturnPostageSelect: string;
  orderReturnPostageSelecting: string;
  orderReturnPostageSelected: string;
  orderReturnPostageExpires: string;
