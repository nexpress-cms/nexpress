...
const messages = {
  ...
  orderExchange: "교환 상품",
  orderExchangeAwaiting: "교환 대기",
  orderExchangeProcessing: "교환 준비",
  orderExchangeShipped: "교환 출고",
  orderExchangeCancelled: "교환 취소",
  orderExchangeInventoryRestocked: "교환 재고 복원",
  orderExchangeInventoryManual: "교환 재고 수동 조정",
  orderExchangeTracking: "교환 배송 조회",
  orderExchangeDestination: "교환품 배송지",
  orderExchangeDestinationAwaiting: "새 배송지를 입력하세요.",
  orderExchangeDestinationSubmitted: "배송지를 보관 중입니다.",
  orderExchangeDestinationAccessed: "관리자가 배송지를 확인했습니다.",
  orderExchangeDestinationExpired: "배송지가 만료되었습니다.",
  orderExchangeDestinationSubmit: "배송지 제출",
  orderExchangeDestinationSubmitting: "배송지 제출 중",
  orderExchangeDestinationPrivacy: "최대 24시간 별도 보관합니다.",
  orderExchangeDestinationFailed: "배송지를 제출하지 못했습니다.",
  ...
  orderReturnPostageQuote: "반품 배송비 조회",
  orderReturnPostageQuoting: "반품 배송비 조회 중",
  orderReturnPostageSelect: "선택",
  orderReturnPostageSelecting: "선택 중",
  orderReturnPostageSelected: "선택한 반품 배송",
  orderReturnPostageExpires: "견적 만료",
  orderReturnPostagePrivacy: "회수 주소는 견적과 함께 1시간 안에 만료",
  orderReturnPostageBoundary: "자동 결제나 환불 차감 없음",
  orderReturnPostageFailed: "반품 배송비 실패",
  orderReturnPostageResponsibility: "반품 배송비 부담",
  orderReturnPostageMerchant: "판매자 부담",
  orderReturnPostageCustomer: "구매자 부담",
  orderReturnPostageDeduction: "반품 배송비 차감",
  orderReturnRefundNet: "최종 환불액",
