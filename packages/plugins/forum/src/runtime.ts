...
export async function getForumMessages(): Promise<NpForumMessages> {
  ...
  const values = await Promise.all(
    [
      ...
      "commentEdited",
      "commentImported",
      "commentImportedTitle",
      "commentUnknownAuthor",
      "commentSignInToReact",
      "commentReportTitle",
  ...
  return {
    ...
    subscribeBoard: subscribeBoard ?? "Subscribe to board",
    subscribedBoard: subscribedBoard ?? "Board subscribed",
    subscribePost: subscribePost ?? "Subscribe to post",
    subscribedPost: subscribedPost ?? "Post subscribed",
    subscriptionLoading: subscriptionLoading ?? "Loading subscription…",
    signInToSubscribe: signInToSubscribe ?? "Sign in to subscribe",
    ...
    hidePost: hidePost ?? "Hide",
    restorePost: restorePost ?? "Publish",
    lockPost: lockPost ?? "Lock",
    unlockPost: unlockPost ?? "Unlock",
    pinPost: pinPost ?? "Pin",
    unpinPost: unpinPost ?? "Unpin",
    moderationActionFailed: moderationActionFailed ?? "Could not update the moderation state.",
    hideComment: hideComment ?? "Hide comment",
    restoreComment: restoreComment ?? "Restore comment",
    hidingComment: hidingComment ?? "Hiding comment…",
    restoringComment: restoringComment ?? "Restoring comment…",
    reportsPending: reportsPending ?? "Pending reports",
    reportReason: reportReason ?? "Reason",
    dismissReport: dismissReport ?? "Dismiss",
    hideReportedComment: hideReportedComment ?? "Hide comment and resolve",
    hideReportedPost: hideReportedPost ?? "Hide post and resolve",
    resolvingReport: resolvingReport ?? "Resolving…",
    resolveReportFailed: resolveReportFailed ?? "Could not resolve the report.",
    report: report ?? "Report",
    reportTitle: reportTitle ?? "Report this post",
    reportHelp: reportHelp ?? "Tell the moderators briefly what is wrong.",
    reportPlaceholder: reportPlaceholder ?? "Spam, harassment, illegal content…",
    reportSubmit: reportSubmit ?? "Send report",
    reportSubmitting: reportSubmitting ?? "Sending…",
    reportSuccess: reportSuccess ?? "Your report was sent to the moderators.",
    reportClose: reportClose ?? "Close",
    reportFailed: reportFailed ?? "Could not send the report.",
    ...
    commentsEmpty: commentsEmpty ?? "No comments yet.",
    commentsLoadFailed: commentsLoadFailed ?? "Could not load comments.",
    commentsSort: commentsSort ?? "Comment sort order",
    commentsOldest: commentsOldest ?? "Oldest",
    commentsNewest: commentsNewest ?? "Newest",
    commentsTop: commentsTop ?? "Top",
    commentsSignInPrompt: commentsSignInPrompt ?? "to comment.",
    commentPlaceholder:
      commentPlaceholder ?? "Write a comment… **bold**, *italic*, `code` supported.",
    commentPost: commentPost ?? "Post comment",
    commentPosting: commentPosting ?? "Posting…",
    commentPostFailed: commentPostFailed ?? "Could not post this comment.",
    commentReply: commentReply ?? "Reply",
    commentReplyingTo: commentReplyingTo ?? "Replying to",
    commentReplyPlaceholder: commentReplyPlaceholder ?? "Write a reply…",
    commentPostReply: commentPostReply ?? "Post reply",
    commentEditFailed: commentEditFailed ?? "Could not edit this comment.",
    commentDeleteConfirm:
      commentDeleteConfirm ?? "Delete this comment? Its text will be removed permanently.",
    commentDeleteFailed: commentDeleteFailed ?? "Could not delete this comment.",
    commentEdited: commentEdited ?? "edited",
    commentImported: commentImported ?? "imported",
    commentImportedTitle: commentImportedTitle ?? "Imported from a WordPress export",
    commentUnknownAuthor: commentUnknownAuthor ?? "Unknown member",
    commentSignInToReact: commentSignInToReact ?? "Log in to react",
    commentReportTitle: commentReportTitle ?? "Report this comment",
    commentReportReasonLabel: commentReportReasonLabel ?? "Report reason",
    commentMute: commentMute ?? "Mute",
    commentMuting: commentMuting ?? "Muting…",
    commentMuteTitle: commentMuteTitle ?? "Mute this member",
    commentMuteConfirm:
      commentMuteConfirm ??
