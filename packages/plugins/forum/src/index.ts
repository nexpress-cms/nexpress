...
const messages = {
  en: {
    ...
    "forum.audience": "Audience",
    "forum.audiencePublic": "Everyone",
    "forum.audienceMembers": "Signed-in members",
    "forum.audiencePrivateBoard": "Moderators only",
    "forum.audiencePrivate": "Author and moderators",
    ...
    "forum.hidePost": "Hide",
    "forum.restorePost": "Publish",
    "forum.lockPost": "Lock",
    "forum.unlockPost": "Unlock",
    "forum.pinPost": "Pin",
    "forum.unpinPost": "Unpin",
    "forum.moderationActionFailed": "Could not update the moderation state.",
    "forum.hideComment": "Hide comment",
    "forum.restoreComment": "Restore comment",
    "forum.hidingComment": "Hiding comment…",
    "forum.restoringComment": "Restoring comment…",
    "forum.reportsPending": "Pending reports",
    "forum.reportReason": "Reason",
    "forum.dismissReport": "Dismiss",
    "forum.hideReportedComment": "Hide comment and resolve",
    "forum.hideReportedPost": "Hide post and resolve",
    "forum.resolvingReport": "Resolving…",
    "forum.resolveReportFailed": "Could not resolve the report.",
    "forum.report": "Report",
  ...
  ko: {
    ...
    "forum.audience": "공개 범위",
    "forum.audiencePublic": "전체 공개",
    "forum.audienceMembers": "회원 공개",
    "forum.audiencePrivateBoard": "운영진만",
    "forum.audiencePrivate": "작성자와 운영자만",
    ...
    "forum.hidePost": "숨기기",
    "forum.restorePost": "게시 승인",
    "forum.lockPost": "잠그기",
    "forum.unlockPost": "잠금 해제",
    "forum.pinPost": "공지로 고정",
    "forum.unpinPost": "공지 해제",
    "forum.moderationActionFailed": "운영 상태를 변경하지 못했습니다.",
    "forum.hideComment": "댓글 숨기기",
    "forum.restoreComment": "댓글 복원",
    "forum.hidingComment": "댓글 숨기는 중…",
    "forum.restoringComment": "댓글 복원 중…",
    "forum.reportsPending": "미처리 신고",
    "forum.reportReason": "신고 사유",
    "forum.dismissReport": "신고 기각",
    "forum.hideReportedComment": "댓글 숨기고 처리",
    "forum.hideReportedPost": "게시글 숨기고 처리",
    "forum.resolvingReport": "처리 중…",
    "forum.resolveReportFailed": "신고를 처리하지 못했습니다.",
    "forum.report": "신고",
