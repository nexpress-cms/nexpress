...
export interface NpForumMessages {
  ...
  commentPostReply: string;
  commentEditFailed: string;
  commentDeleteConfirm: string;
  commentDeleteFailed: string;
  commentEdited: string;
  commentImported: string;
  commentImportedTitle: string;
  commentUnknownAuthor: string;
  commentSignInToReact: string;
  commentReportTitle: string;
  commentReportReasonLabel: string;
  commentMute: string;
  commentMuting: string;
  commentMuteTitle: string;
  commentMuteConfirm: string;
