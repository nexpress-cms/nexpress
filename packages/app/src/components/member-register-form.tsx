...
export function RegisterForm() {
    ...
    return (
      <div className="np-members-form">
        <div className="np-form-success" role="status">
          ...
          <p>
            We sent a verification link to <code>{fields.email.value}</code>. Click it to activate
  ...
  const handleValid = fields.handle.value === "" || npIsCanonicalMemberHandle(fields.handle.value);
    ...
    >
      ...
      <label className="np-form-field">
        ...
        <input
          ...
          className="np-form-input"
        />
        {errors.displayName ? <span className="np-form-error">{errors.displayName}</span> : null}
      </label>
      <label className="np-form-field">
        ...
        <input
          ...
          pattern={npMemberHandlePattern.slice(1, -1)}
      ...
      <div className="np-form-actions">
        <button
          ...
          disabled={
            ...
            !npIsCanonicalMemberHandle(fields.handle.value) ||
