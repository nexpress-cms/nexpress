...
const OPS_CONTRACTS: OpsContract[] = [
  {
    ...
    projectCommand: "pnpm run deploy:plan -- --target <host> --json",
  ...
  },
  {
    ...
    projectCommand: "pnpm run ops:status -- --json",
  ...
  },
  {
    ...
    projectCommand: "pnpm run ops:contracts -- --json",
  ...
  },
  {
    ...
    projectCommand: "pnpm run ops:preflight -- --target <host> --json",
  ...
  },
  {
    ...
    projectCommand: "pnpm run ops:health -- --url <origin> --json",
  ...
  },
  {
    ...
    projectCommand: "pnpm run ops:migrate -- status|plan|rollback-plan --json",
  ...
  },
  {
    ...
    projectCommand: "pnpm run ops:backup -- status|create|list|verify|restore-plan --json",
  ...
  },
  {
    ...
    projectCommand: "pnpm run ops:jobs -- status|pause|resume|retry-all|drain --json",
  ...
  },
  {
    ...
    projectCommand:
      "pnpm run ops:storage -- status|verify|missing-files|orphaned-files|migrate plan|test --json",
    schemaVersions: [
      "np.ops-storage.v1",
  ...
  },
  {
    ...
    projectCommand: "pnpm run ops:plugins -- list|inspect|doctor|upgrade-plan --json",
  ...
  },
  {
    ...
    projectCommand: "pnpm run ops:release -- check|plan|apply|verify --json",
  ...
  },
  {
    ...
    projectCommand: "pnpm run ops:runbook -- <incident> --json",
  ...
  },
  {
    ...
    projectCommand: "pnpm run doctor:prod -- --fix-plan --json",
