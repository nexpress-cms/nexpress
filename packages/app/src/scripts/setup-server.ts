          ...
          <section class="step-panel hidden" data-step="done">
            <div class="done">
              ...
              <div class="nextcards">
                ...
                <div class="nextcard"><div class="nextcard-top"><span class="nextcard-ico" data-icon="shield"></span><span class="mono">deploy</span></div><b>Run deploy bridge</b><span class="mono">pnpm run ops:preflight -- --target vercel</span></div>
              </div>
