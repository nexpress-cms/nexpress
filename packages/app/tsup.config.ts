...
const scriptEntries = {
  ...
  "scripts/generate-migrations": "src/scripts/generate-migrations.ts",
  "scripts/generate-migrations-core": "src/scripts/generate-migrations-core.ts",
  "scripts/agent-migration-contract": "src/scripts/agent-migration-contract.ts",
  "scripts/ops-backup": "src/scripts/ops-backup.ts",
  "scripts/ops-backup-core": "src/scripts/ops-backup-core.ts",
  "scripts/ops-cache-core": "src/scripts/ops-cache-core.ts",
...
const libEntries = {
  ...
  "lib/community-realtime-health": "src/lib/community-realtime-health.ts",
  ...
  "lib/scheduled-publish-revalidate": "src/lib/scheduled-publish-revalidate.ts",
