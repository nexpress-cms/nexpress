...
WordPress (WXR) importer for [NexPress](https://github.com/nexpress-cms/nexpress).
...
- [docs/wordpress-import-guide.md](https://github.com/nexpress-cms/nexpress/blob/main/docs/wordpress-import-guide.md)
- [packages/wp-import/src/cli/](https://github.com/nexpress-cms/nexpress/tree/main/packages/wp-import/src/cli)

## Stability

Per the
[Stability section in AGENTS.md](https://github.com/nexpress-cms/nexpress/blob/main/AGENTS.md):
