...
function envExampleTemplate(config: TemplateConfig): string {
  ...
  return [
    ...
    "",
    "# Optional server-only Shop carrier booking adapter.",
    ...
    "# Labels, pickup, and tracking webhooks remain separate integrations.",
    "",
