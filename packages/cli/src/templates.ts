...
function envExampleTemplate(config: TemplateConfig): string {
  ...
  return [
    ...
    "",
    "# Optional Toss Payments v2 initiation and full-refund adapter for Shop.",
