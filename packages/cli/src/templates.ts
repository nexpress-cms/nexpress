...
function envExampleTemplate(config: TemplateConfig): string {
  ...
  return [
    ...
    "# must not charge, deduct a refund, or decide who pays for the return.",
