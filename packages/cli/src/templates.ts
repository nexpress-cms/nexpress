...
function envExampleTemplate(config: TemplateConfig): string {
  ...
  return [
    ...
    "",
    "# Optional Toss Payments v2 initiation, full-refund, and received-return partial-refund adapter for Shop.",
