...
function envExampleTemplate(config: TemplateConfig): string {
  ...
  return [
    ...
    "# collects a price difference, or automatically approves the exchange.",
    "",
...
5. A carrier may pair \`bookExchangeShipment\` with \`cancelExchangeShipment\`. Shop persists stable provider idempotency, deletes the replacement destination only after durable confirmation, and makes ambiguous booking or cancellation explicitly resumable. Replacement labels, pickup, and tracking callbacks remain separate.
