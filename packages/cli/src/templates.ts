...
function envExampleTemplate(config: TemplateConfig): string {
  ...
  return [
    ...
    "# This intent does not prove physical packing or add picking/bin/worker state,",
    "# addresses, rates, labels, material inventory/reservation/purchase, or",
    "# provider-specific WMS callbacks/polling. Omission preserves manual flows.",
    "",
