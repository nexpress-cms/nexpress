...
A NexPress site ready to customize, publish, and deploy, with Shop saved products on the existing site-scoped follow graph at \`/shop/wishlist\`, independent one-shot member restock alerts for exact out-of-stock inventory targets, and a durable PII-free order-update timeline/outbox.
