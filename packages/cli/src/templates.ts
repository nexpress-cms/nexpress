...
function envExampleTemplate(config: TemplateConfig): string {
  ...
  return [
    ...
    "# Optional verifyPackingStatusWebhook authenticates exact raw WMS callbacks",
    "# into monotonic PII-free accepted/picking/failed/packed evidence and receipts.",
    ...
    "# authoritative completion policy, or WMS polling. Omission preserves manual flows.",
    "",
